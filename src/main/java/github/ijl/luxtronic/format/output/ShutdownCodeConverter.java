...
public class ShutdownCodeConverter extends AbstractMapBasedConverter {
    private static final Object[][] HUMAN_READABLE_VALUES = new Object[][]{{1, "1: heat pump fault"}, {2, "2: system fault"}, {3, "3: operating mode second heat generator"},
            {4, "4: power supply lock"}, {5, "5: running defrost (only LW devices)"}, {6, "6: temperature maximum operating limit"},
